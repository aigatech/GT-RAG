...
class GTWikiScraper(BaseScraper):
    ...
    rejectList = [
        ...
        "User_talk:143.215.110.166", 
        "Special:Contributions",
        "title=Special:CreateAccount&returnto=Special%3AContributions%2F143.215.110.166",
        "title=Special:UserLogin&returnto=Special%3AContributions%2F143.215.110.166",
        "https://discord.com",
        "index.php?search=&title=Special%3ASearch&go=Go",
        "Contributing#Course_Pages",
        "Course_Template",
        "Guidelines:Course_Pages",
        "action=edit",
        "action=history",
        "Help:Categories",
        ...
        try:
            ...
            with open(filepath, 'w', encoding='utf-8') as f:
                ...
                for link in soup.find_all('a', href=True):
                    ...
                    # Reject any redundant URLs
                    if any(web in next_url for web in rejectList):
                        return
                    else:
